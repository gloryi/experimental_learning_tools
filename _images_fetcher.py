...
greedy_crawler.crawl(
    domains=shikimori_urls, max_num=0, min_size=(1280, 720), max_size=None
)
exit()
...
for ani_url in shikimori_urls:
    ...
    greedy_crawler.crawl(
        ...
        min_size=(1280, 720),
        max_size=None,
        file_idx_offset=len_existing + 1,
    )
exit()
...
p5 = 2500000
with open(
    os.path.join(os.getcwd(), "datasets", "world_cities_parsed.csv")
) as sources_file:
    ...
    for i, line in enumerate(reader):
        ...
        google_crawler.crawl(
            keyword=f"{city} {country}",
            filters=filters,
            offset=0,
            max_num=5,
            file_idx_offset=initial_offset,
        )
